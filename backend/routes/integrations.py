...
async def calendar_auth(wallet: str):
    """Proxy for Google Calendar OAuth URL generation via InsForge edge function."""
    ...
    try:
        async with httpx.AsyncClient() as client:
            response = await client.get(
                f"{INSFORGE_BASE_URL}/functions/v1/calendar-auth",
